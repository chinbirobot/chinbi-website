...
The brand mark (`dist/assets/chinbi-wolf.png`) is the wolf head from the official Chinbi Robotics logo, cropped without the wordmark and kept in its original colours (black mane, white face) with the area outside the silhouette made transparent. It is used in the header, footer, favicon (`favicon-64.png`) and Apple touch icon.
